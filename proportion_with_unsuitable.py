...
unsuitable_cod_records = death_records[death_records['Underlying COD'].isin(unsuitable_codes)]
...
print(f'The proportion of records with an unsuitable cause of death is {proportion:.2f}')
